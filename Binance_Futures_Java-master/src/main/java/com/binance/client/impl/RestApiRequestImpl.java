...
class RestApiRequestImpl {
    ...
    RestApiRequest<Order> postOrder(String symbol, OrderSide side, PositionSide positionSide, OrderType orderType,
                                    ...
                                    String newClientOrderId, String stopPrice, WorkingType workingType, NewOrderRespType newOrderRespType, boolean closePosition, String placeType) {
        RestApiRequest<Order> request = new RestApiRequest<>();
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                .putToUrl("symbol", symbol)
                .putToUrl("side", side)
                .putToUrl("placeType", placeType)
                ...
                .putToUrl("closePosition", String.valueOf(closePosition))
    ...
    RestApiRequest<ResponseResult> changeMarginType(String symbolName, MarginType marginType) {
        ...
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                ...
                .putToUrl("marginType", marginType.toString());
    ...
    RestApiRequest<PositionSideEntity> getPositionSide() {
        RestApiRequest<PositionSideEntity> request = new RestApiRequest<>();
        UrlParamsBuilder builder = UrlParamsBuilder.build();
        request.request = createRequestByGetWithSignature("/fapi/v1/positionSide/dual", builder);

        request.jsonParser = (jsonWrapper -> {
            PositionSideEntity result = new PositionSideEntity();
            result.setDualSidePosition(jsonWrapper.getBoolean("dualSidePosition"));
            return result;
        });
        return request;
    }
    ...
    RestApiRequest<Leverage> getInitialLeverage(String symbol) {
        RestApiRequest<Leverage> request = new RestApiRequest<>();
        UrlParamsBuilder builder = UrlParamsBuilder.build()
                .putToUrl("symbol", symbol);
        request.request = createRequestByGetWithSignature("/fapi/v1/leverage", builder);
