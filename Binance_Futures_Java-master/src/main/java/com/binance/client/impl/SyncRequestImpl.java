...
public class SyncRequestImpl implements SyncRequestClient {
    ...
    public Order postOrder(String symbol, OrderSide side, PositionSide positionSide, OrderType orderType,
        ...
        return RestApiInvoker.callSync(requestImpl.postOrder(symbol, side, positionSide, orderType,
                ...
                newClientOrderId, stopPrice, workingType,newOrderRespType,closePosition,placeType));
    }
    ...
    @Override
    public PositionSideEntity getPositionSide() {
    ...
    @Override
    public Leverage getInitialLeverage(String symbol) {
        return RestApiInvoker.callSync(requestImpl.getInitialLeverage(symbol));
    }
